...
public class Util {
    ...
    public static boolean isStringsNotNull(String... strs) {
        for (String str : strs) {
            if (isStringNull(str)) {
                return false;
            }
    ...
    public static int getToolbarBgAlpha(Toolbar toolbar) {
        return toolbar.getBackground().getAlpha();
    }
    */
    ...
    public static void changeStatusBarColor(Activity activity, int resColor) {
    ...
    /**
     * Must be executed in AsyncTask or Service
     */
    public static Bitmap getVideoFrameFromVideo(String videoPath) throws Throwable {
        ...
        try {
            ...
            e.printStackTrace();
            throw new Throwable("Exception in getVideoFrameFromVideo(String videoPath)" +
                    e.getMessage());
        } finally {
    ...
    public static Locale getCurrentKeyboardLocale(Context context) {
        try {
            ...
            return new Locale(ims.getLocale());
        } catch (Exception e) {
            e.printStackTrace();
        }
